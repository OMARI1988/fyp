...
def main():
	...
	stacker = stack(limb, distance, objects)	
	...
	#stacker.pose = (stacker.start_pos_x,
	#	            stacker.start_pos_y,
	#	            stacker.start_pos_z,
	#	            stacker.roll,
	#	            stacker.pitch,
	#	            stacker.yaw)
	#stacker.baxter_ik_move(stacker.limb, stacker.pose)
...
class stack():
	def __init__(self, arm, distance, objects):
		...
		self.x = np.zeros(shape=(len(objects)), dtype=int)
		self.y = np.zeros(shape=(len(objects)), dtype=int)
