...
#--------------------------------------------------------------------------------------------------------------------------------------------#
			...
			# for detecting the board		
				...
				for cnt in contours:
					...
					if cv2.contourArea(cnt)>40000:
							...
							mod = h/3
							points.append((cx,cy))
							points.append((cx,cy+mod))
							points.append((cx,cy-mod))
							points.append((cx+mod,cy))
							points.append((cx-mod,cy))
							points.append((cx+mod,cy+mod))
							points.append((cx+mod,cy-mod))
							points.append((cx-mod,cy-mod))
							points.append((cx-mod,cy+mod))
							for point in points:
	...
	def place_piece(self, x, y, level):
		...
		self.find_object(1)				
		self.pickup_object()						
		self.drop_on(self.boardPos[x][y],level)	
		self.start_position()					
	...
	def locate_board(self):
		self.setSpeed(self.slow)
		self.boardPos[1][1] = self.find_object(2)

		self.boardPos[1][2] = (self.boardPos[1][1][0] + (self.boardHeight/3),
							self.boardPos[1][1][1],
							self.boardPos[1][1][2],
							self.boardPos[1][1][3],
							self.boardPos[1][1][4],
		...
		self.boardPos[1][0] = (self.boardPos[1][1][0] - (self.boardHeight/3),
							self.boardPos[1][1][1],
							self.boardPos[1][1][2],
							self.boardPos[1][1][3],
							self.boardPos[1][1][4],
		...
		self.boardPos[2][1] = (self.boardPos[1][1][0],
							self.boardPos[1][1][1] + (self.boardHeight/3),
							self.boardPos[1][1][2],
							self.boardPos[1][1][3],
							self.boardPos[1][1][4],
							self.boardPos[1][1][5])

		self.boardPos[0][1] = (self.boardPos[1][1][0],
							self.boardPos[1][1][1] - (self.boardHeight/3),
							self.boardPos[1][1][2],
							self.boardPos[1][1][3],
							self.boardPos[1][1][4],
		...
		self.boardPos[0][0] = (self.boardPos[1][1][0] - (self.boardHeight/3),
							self.boardPos[1][1][1] - (self.boardHeight/3),
							self.boardPos[1][1][2],
							self.boardPos[1][1][3],
							self.boardPos[1][1][4],
		...
		self.boardPos[2][0] = (self.boardPos[1][1][0] - (self.boardHeight/3),
							self.boardPos[1][1][1] + (self.boardHeight/3),
							self.boardPos[1][1][2],
							self.boardPos[1][1][3],
							self.boardPos[1][1][4],
		...
		self.boardPos[2][2] = (self.boardPos[1][1][0] + (self.boardHeight/3),
							self.boardPos[1][1][1] + (self.boardHeight/3),
							self.boardPos[1][1][2],
							self.boardPos[1][1][3],
							self.boardPos[1][1][4],
		...
		self.boardPos[0][2] = (self.boardPos[1][1][0] + (self.boardHeight/3),
							self.boardPos[1][1][1] - (self.boardHeight/3),
							self.boardPos[1][1][2],
							self.boardPos[1][1][3],
							self.boardPos[1][1][4],
